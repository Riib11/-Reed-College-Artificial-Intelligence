...
class ExactInference(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.beliefs = util.Counter() # pacmanPosition => Float
    ...
    def observe(self, observation, gameState):
        ...
        A correct implementation will handle the following special case:
          *  When a ghost is captured by Pacman, all beliefs should be updated
             ...
             captured).
        """
        # noisyDistance : Float # estimated Manhattan distance to tracked ghost
        noisyDistance = observation
        # emissionModel : Float # trueDistance => P(noisyDistance | trueDistance)
        ...
        if noisyDistance == None:
            # know exactly that ghost is in jail
            for pos in self.legalPositions: beliefs[pos] = 0.0
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        particlesLeftover = self.numParticles - (len(positions) * particlesPerPos)

        def addParticles(pos, n):
            for _ in range(n):
        ...
        for pos in positions:
            addParticles(pos, particlesPerPos)
        # leftover particles
...
class MarginalInference(InferenceModule):
    ...
    def getBeliefDistribution(self):
        ...
        # dist :: (ghostPositions) => Probability
        dist = util.Counter()
...
class JointParticleFilter:
    ...
    def initialize(self, gameState, legalPositions):
        ...
        self.particleSpace = itertools.product \
            ( [self.legalPositions] * self.numGhosts )
    ...
    def initializeParticles(self):
        ...
        self.weights = []
        for _ in range(self.numParticles):
            self.particles.append(random.choice(self.particleSpace))
            self.weights.append(1)
    ...
    def observeState(self, gameState):
        ...
        for iPart, ps in enumerate(self.particles):
            ...
            self.weights[ps] = weight / sef.numGhosts # TODO: this might need to change, based on above, as well
